...
\item
  ...
  \emph{.xlsx}\index{.xlsx: Dateinamenserweiterung einer Excel Datei}
  Datei
\item
...
dazu ein \emph{Template}\index{Template: zu Deutsch: Vorlage, Schablone}
...
\NormalTok{{-}X ItemSplitChangeProposal,MultipleValidationsChangeProposal, \textbackslash{}}
\NormalTok{   ValueChangeProposal,TimeStampMixin \textbackslash{}}
