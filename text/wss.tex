...
diesen Skripts bezieht Ralph von Docker-Hub ihre Docker-Images und
wandelt sie dann in Container um. Es wäre also ein großer Aufwand
gewesen, diese Skripts für die Zwecke von ``Capentory'' anzupassen,
daher stieg das Projektteam auf die Verwendung von uWSGI um. Jedoch gibt
es eine eigene Docker-Variante für die Entwicklungsumgebung die rasch
mit uWSGI in eine Produktivumgebung umgewandelt werden kann.
