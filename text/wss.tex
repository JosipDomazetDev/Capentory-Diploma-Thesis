...
Nach kurzer Recherche stieß er schließlich auf zwei verwendbare
Alternativen, die unter Punkt \ref{alternativen} genannt und unter Punkt
\ref{uwsgi-vs.-gunicorn} verglichen werden.
