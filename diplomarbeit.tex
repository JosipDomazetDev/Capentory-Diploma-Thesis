...
Dieses Ziel wird in folgendem Kapitel näher erläutert: \plainsiehe{das-capentory-modul}.
  ...
  \subsection*{Ziel M2: Datenimport/-export}
    ...
    Dieses Ziel wird in folgendem Kapitel näher erläutert: \plainsiehe{technische-umsetzung-infrastruktur}.
      ...
      Dieses Ziel wird in folgenden Kapiteln näher erläutert: \plainsiehe{anschaffung-des-servers}, \plainsiehe{wahl-des-betriebssystems} und \plainsiehe{installation-des-betriebsystemes}.
...
Die vorliegende Diplomarbeit kann vereinfacht durch die \abb{fig:gesamt} ausgedrückt werden. Die vorliegende Diplomarbeit kann dabei in drei Bereiche unterteilt werden. Die restlichen Kapitel erläutern die konkrete Implementierung und Funktionsweise dieser Bereiche: 
