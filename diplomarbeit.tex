...
Der Server basiert auf dem frei verfügbaren Anlagenverwaltungstool "ralph", das von der polnischen Internetauktionsplattform "Allegro" verwendet und entwickelt wird \cite{ralph}. Sowohl die App als auch der Server wurden vom Projektteam so entwickelt, dass sie mit ralph 
...
Dieses Ziel wird in folgendem Kapitel näher erläutert: \plainsiehe{das-capentory-modul}.
  ...
  \subsection*{Ziel M2: Datenimport/-export}
    ...
    Dieses Ziel wird in folgendem Kapitel näher erläutert: \plainsiehe{technische-umsetzung-infrastruktur}.
      ...
      Dieses Ziel wird in folgenden Kapiteln näher erläutert: \plainsiehe{anschaffung-des-servers}, \plainsiehe{wahl-des-betriebsystemes} und \plainsiehe{installation-des-betriebsystemes}.
      ...
      Dieses Ziel wird in folgenden Kapiteln näher erläutert:\plainsiehe{konfiguration-der-netzwerkschnittstellen} und \plainsiehe{installation-der-notwendigen-applikationen}.
      ...
      Dieses Ziel wird in folgendem Kapitel näher erläutert: \plainsiehe{die-fragments}.
